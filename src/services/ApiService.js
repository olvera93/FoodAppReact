...
export default class ApiService {
    ...
    // Login user
    static async loginUser(registrationData) {
        const resp = await axios.post(`${this.BASE_URL}/auth/login`, registrationData);
        return resp.data;
    }

    /** USERS PROFILE MANAGEMENT SECCION */
    static async myProfile() {
        const resp = await axios.get(`${this.BASE_URL}/users/account`, {headers: this.getHeader()});
        return resp.data;
    }
    ...
    static async deactivateAccount() {
        const resp = await axios.delete(`${this.BASE_URL}/users/deactivate`, {headers: this.getHeader()});
        return resp.data;
    }
