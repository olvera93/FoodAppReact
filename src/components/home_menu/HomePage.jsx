...
const HomePage = () => {
    ...
    const hangleCategoryClick = (categoryId) => {
        ...
        <div className="home-page">
            ...
            <header className="home-hero-section">
                <div className="home-hero-content">
                    ...
                    <p className="home-hero-subtitle">Order your favourite food online quickly and easily</p>
            ...
            <section className="home-featured-categories">
                ...
                <div className="home-category-carousel">
                    { categories.map((category) => (
                        <div key={category.id} className="home-category-card" onClick={() => hangleCategoryClick(category.id)}>
            ...
            <section className="home-call-to-action">
                <div className="home-cta-content">
                    ...
                    <p className="home-cta-text">Browse out menu and place your order</p>
                    <button className="home-order-now-button" onClick={() => navigate('/menu')}>Order Now</button>
                </div>
            </section>
